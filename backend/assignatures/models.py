...
class Avaluacio(models.Model):
	...
	def recalculate_dimensions_avaluacio(self):
		...
		qs_dimensions = qs.dimensions_avaluacio.all().exclude(nom__iexact='_Total')
		print qs_dimensions
		
		# print(qs_dimensions)
		dimensio_avaluacio_obj = qs.dimensions_avaluacio.filter(nom__iexact='_Total').first()
