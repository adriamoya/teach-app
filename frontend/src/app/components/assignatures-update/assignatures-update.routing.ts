...
export const ASSIGNATURES_UPDATE_ROUTES: Routes = [
  { path: 'general', component: AssignaturesUpdateGeneralComponent },
  { path: 'proves', component: AssignaturesUpdateProvesComponent },
  { path: 'alumnes', component: AssignaturesUpdateAlumnesComponent },
